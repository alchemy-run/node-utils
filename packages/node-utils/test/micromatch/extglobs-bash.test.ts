...
describe('extglobs (bash)', () => {
  ...
  afterEach(() => ((path as any).sep = process.env.ORIGINAL_PATH_SEP));

  test('should not match empty string iwth "*(0|1|3|5|7|9)"', () => {
    expect_truthy(!isMatch('', '*(0|1|3|5|7|9)', { bash: true }));
  });
  ...
  test('"***" should match "\\*\\*\\*"', () => {
    expect_truthy(isMatch('***', '\\*\\*\\*', { bash: true }));
  });

  test('"-adobe-courier-bold-o-normal--12-120-75-75-/-70-iso8859-1" should not match "-*-*-*-*-*-*-12-*-*-*-m-*-*-*"', () => {
    expect_truthy(!isMatch('-adobe-courier-bold-o-normal--12-120-75-75-/-70-iso8859-1', '-*-*-*-*-*-*-12-*-*-*-m-*-*-*', { bash: true }));
  });

  test('"-adobe-courier-bold-o-normal--12-120-75-75-m-70-iso8859-1" should match "-*-*-*-*-*-*-12-*-*-*-m-*-*-*"', () => {
    expect_truthy(isMatch('-adobe-courier-bold-o-normal--12-120-75-75-m-70-iso8859-1', '-*-*-*-*-*-*-12-*-*-*-m-*-*-*', { bash: true }));
  });

  test('"-adobe-courier-bold-o-normal--12-120-75-75-X-70-iso8859-1" should not match "-*-*-*-*-*-*-12-*-*-*-m-*-*-*"', () => {
    expect_truthy(!isMatch('-adobe-courier-bold-o-normal--12-120-75-75-X-70-iso8859-1', '-*-*-*-*-*-*-12-*-*-*-m-*-*-*', { bash: true }));
  });

  test('"/dev/udp/129.22.8.102/45" should match "/dev\\/@(tcp|udp)\\/*\\/*"', () => {
    expect_truthy(isMatch('/dev/udp/129.22.8.102/45', '/dev\\/@(tcp|udp)\\/*\\/*', { bash: true }));
  });

  test('"/x/y/z" should match "/x/y/z"', () => {
    expect_truthy(isMatch('/x/y/z', '/x/y/z', { bash: true }));
  });

  test('"0377" should match "+([0-7])"', () => {
    expect_truthy(isMatch('0377', '+([0-7])', { bash: true }));
  });

  test('"07" should match "+([0-7])"', () => {
    expect_truthy(isMatch('07', '+([0-7])', { bash: true }));
  });

  test('"09" should not match "+([0-7])"', () => {
    expect_truthy(!isMatch('09', '+([0-7])', { bash: true }));
  });

  test('"1" should match "0|[1-9]*([0-9])"', () => {
    expect_truthy(isMatch('1', '0|[1-9]*([0-9])', { bash: true }));
  });

  test('"12" should match "0|[1-9]*([0-9])"', () => {
    expect_truthy(isMatch('12', '0|[1-9]*([0-9])', { bash: true }));
  });

  test('"123abc" should not match "(a+|b)*"', () => {
    expect_truthy(!isMatch('123abc', '(a+|b)*', { bash: true }));
  });
  ...
  test('"123abc" should match "*?(a)bc"', () => {
    expect_truthy(isMatch('123abc', '*?(a)bc', { bash: true }));
  });

  test('"123abc" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('123abc', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"123abc" should not match "ab*(e|f)"', () => {
    expect_truthy(!isMatch('123abc', 'ab*(e|f)', { bash: true }));
  });

  test('"123abc" should not match "ab**"', () => {
    expect_truthy(!isMatch('123abc', 'ab**', { bash: true }));
  });
  ...
  test('"123abc" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('123abc', 'ab**(e|f)g', { bash: true }));
  });

  test('"123abc" should not match "ab***ef"', () => {
    expect_truthy(!isMatch('123abc', 'ab***ef', { bash: true }));
  });
  ...
  test('"123abc" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('123abc', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"12abc" should not match "0|[1-9]*([0-9])"', () => {
    expect_truthy(!isMatch('12abc', '0|[1-9]*([0-9])', { bash: true }));
  });

  test('"137577991" should match "*(0|1|3|5|7|9)"', () => {
    expect_truthy(isMatch('137577991', '*(0|1|3|5|7|9)', { bash: true }));
  });

  test('"2468" should not match "*(0|1|3|5|7|9)"', () => {
    expect_truthy(!isMatch('2468', '*(0|1|3|5|7|9)', { bash: true }));
  });

  test('"?a?b" should match "\\??\\?b"', () => {
    expect_truthy(isMatch('?a?b', '\\??\\?b', { bash: true }));
  });

  test('"\\a\\b\\c" should not match "abc"', () => {
    expect_truthy(!isMatch('\\a\\b\\c', 'abc', { bash: true }));
  });

  test('"a" should match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(isMatch('a', '!(*.a|*.b|*.c)', { bash: true }));
  });

  test('"a" should not match "!(a)"', () => {
    expect_truthy(!isMatch('a', '!(a)', { bash: true }));
  });
  ...
  test('"a" should match "?"', () => {
    expect_truthy(isMatch('a', '?', { bash: true }));
  });

  test('"a" should match "?(a|b)"', () => {
    expect_truthy(isMatch('a', '?(a|b)', { bash: true }));
  });
  ...
  test('"a" should match "a?(x)"', () => {
    expect_truthy(isMatch('a', 'a?(x)', { bash: true }));
  });
  ...
  test('"a." should not match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(!isMatch('a.', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });

  test('"a." should not match "*.+(b|d)"', () => {
    expect_truthy(!isMatch('a.', '*.+(b|d)', { bash: true }));
  });
  ...
  test('"a.a" should not match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(!isMatch('a.a', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"a.a" should match "(b|a).(a)"', () => {
    expect_truthy(isMatch('a.a', '(b|a).(a)', { bash: true }));
  });
  ...
  test('"a.a" should not match "*.!(a)"', () => {
    expect_truthy(!isMatch('a.a', '*.!(a)', { bash: true }));
  });
  ...
  test('"a.a" should match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(isMatch('a.a', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });

  test('"a.a" should not match "*.+(b|d)"', () => {
    expect_truthy(!isMatch('a.a', '*.+(b|d)', { bash: true }));
  });
  ...
  test('"a.a.a" should match "*.!(a)"', () => {
    expect_truthy(isMatch('a.a.a', '*.!(a)', { bash: true }));
  });

  test('"a.a.a" should not match "*.+(b|d)"', () => {
    expect_truthy(!isMatch('a.a.a', '*.+(b|d)', { bash: true }));
  });

  test('"a.aa.a" should not match "(b|a).(a)"', () => {
    expect_truthy(!isMatch('a.aa.a', '(b|a).(a)', { bash: true }));
  });
  ...
  test('"a.abcd" should match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(isMatch('a.abcd', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"a.abcd" should match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(isMatch('a.abcd', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });
  ...
  test('"a.b" should not match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(!isMatch('a.b', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"a.b" should match "*.!(a)"', () => {
    expect_truthy(isMatch('a.b', '*.!(a)', { bash: true }));
  });
  ...
  test('"a.b" should match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(isMatch('a.b', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });

  test('"a.b" should match "*.+(b|d)"', () => {
    expect_truthy(isMatch('a.b', '*.+(b|d)', { bash: true }));
  });
  ...
  test('"a.bb" should match "(a|d).(a|b)*"', () => {
    expect_truthy(isMatch('a.bb', '(a|d).(a|b)*', { bash: true }));
  });

  test('"a.bb" should not match "(b|a).(a)"', () => {
    expect_truthy(!isMatch('a.bb', '(b|a).(a)', { bash: true }));
  });

  test('"a.bb" should match "*.+(b|d)"', () => {
    expect_truthy(isMatch('a.bb', '*.+(b|d)', { bash: true }));
  });
  ...
  test('"a.c" should not match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(!isMatch('a.c', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"a.c" should not match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(!isMatch('a.c', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });

  test('"a.c.d" should match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(isMatch('a.c.d', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"a.c.d" should not match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(!isMatch('a.c.d', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });
  ...
  test('"a.ccc" should not match "*.+(b|d)"', () => {
    expect_truthy(!isMatch('a.ccc', '*.+(b|d)', { bash: true }));
  });
  ...
  test('"a.js" should not match "a.!(js)"', () => {
    expect_truthy(!isMatch('a.js', 'a.!(js)', { bash: true }));
  });
  ...
  test('"a.js.js" should not match "!(*.js)"', () => {
    expect_truthy(!isMatch('a.js.js', '!(*.js)', { bash: true }));
  });
  ...
  test('"a.js.js" should match "*.*(js).js"', () => {
    expect_truthy(isMatch('a.js.js', '*.*(js).js', { bash: true }));
  });

  test('"a.md" should match "!(*.js)"', () => {
    expect_truthy(isMatch('a.md', '!(*.js)', { bash: true }));
  });
  ...
  test('"a.md" should match "a.!(js)"', () => {
    expect_truthy(isMatch('a.md', 'a.!(js)', { bash: true }));
  });
  ...
  test('"a.md.js" should not match "*.*(js).js"', () => {
    expect_truthy(!isMatch('a.md.js', '*.*(js).js', { bash: true }));
  });

  test('"a.txt" should match "a.!(js)"', () => {
    expect_truthy(isMatch('a.txt', 'a.!(js)', { bash: true }));
  });
  ...
  test('"a/!(z)" should match "a/!(z)"', () => {
    expect_truthy(isMatch('a/!(z)', 'a/!(z)', { bash: true }));
  });

  test('"a/b" should match "a/!(z)"', () => {
    expect_truthy(isMatch('a/b', 'a/!(z)', { bash: true }));
  });

  test('"a/b/c.txt" should not match "*/b/!(*).txt"', () => {
    expect_truthy(!isMatch('a/b/c.txt', '*/b/!(*).txt', { bash: true }));
  });

  test('"a/b/c.txt" should not match "*/b/!(c).txt"', () => {
    expect_truthy(!isMatch('a/b/c.txt', '*/b/!(c).txt', { bash: true }));
  });

  test('"a/b/c.txt" should match "*/b/!(cc).txt"', () => {
    expect_truthy(isMatch('a/b/c.txt', '*/b/!(cc).txt', { bash: true }));
  });

  test('"a/b/cc.txt" should not match "*/b/!(*).txt"', () => {
    expect_truthy(!isMatch('a/b/cc.txt', '*/b/!(*).txt', { bash: true }));
  });

  test('"a/b/cc.txt" should not match "*/b/!(c).txt"', () => {
    expect_truthy(!isMatch('a/b/cc.txt', '*/b/!(c).txt', { bash: true }));
  });

  test('"a/b/cc.txt" should not match "*/b/!(cc).txt"', () => {
    expect_truthy(!isMatch('a/b/cc.txt', '*/b/!(cc).txt', { bash: true }));
  });

  test('"a/dir/foo.txt" should match "*/dir/**/!(bar).txt"', () => {
    expect_truthy(isMatch('a/dir/foo.txt', '*/dir/**/!(bar).txt', { bash: true }));
  });
  ...
  test('"aa" should not match "!(a!(b))"', () => {
    expect_truthy(!isMatch('aa', '!(a!(b))', { bash: true }));
  });

  test('"aa" should match "!(a)"', () => {
    expect_truthy(isMatch('aa', '!(a)', { bash: true }));
  });
  ...
  test('"aa" should not match "?"', () => {
    expect_truthy(!isMatch('aa', '?', { bash: true }));
  });
  ...
  test('"aa.aa" should not match "(b|a).(a)"', () => {
    expect_truthy(!isMatch('aa.aa', '(b|a).(a)', { bash: true }));
  });
  ...
  test('"aaa" should not match "!(a)*"', () => {
    expect_truthy(!isMatch('aaa', '!(a)*', { bash: true }));
  });

  test('"aaa" should match "a!(b)*"', () => {
    expect_truthy(isMatch('aaa', 'a!(b)*', { bash: true }));
  });

  test('"aaaaaaabababab" should match "*ab"', () => {
    expect_truthy(isMatch('aaaaaaabababab', '*ab', { bash: true }));
  });

  test('"aaac" should match "*(@(a))a@(c)"', () => {
    expect_truthy(isMatch('aaac', '*(@(a))a@(c)', { bash: true }));
  });

  test('"aaaz" should match "[a*(]*z"', () => {
    expect_truthy(isMatch('aaaz', '[a*(]*z', { bash: true }));
  });

  test('"aab" should not match "!(a)*"', () => {
    expect_truthy(!isMatch('aab', '!(a)*', { bash: true }));
  });

  test('"aab" should not match "?"', () => {
    expect_truthy(!isMatch('aab', '?', { bash: true }));
  });
  ...
  test('"aab" should not match "@(c)b"', () => {
    expect_truthy(!isMatch('aab', '@(c)b', { bash: true }));
  });

  test('"aab" should match "a!(b)*"', () => {
    expect_truthy(isMatch('aab', 'a!(b)*', { bash: true }));
  });
  ...
  test('"aac" should match "*(@(a))a@(c)"', () => {
    expect_truthy(isMatch('aac', '*(@(a))a@(c)', { bash: true }));
  });

  test('"aac" should not match "*(@(a))b@(c)"', () => {
    expect_truthy(!isMatch('aac', '*(@(a))b@(c)', { bash: true }));
  });

  test('"aax" should not match "a!(a*|b)"', () => {
    expect_truthy(!isMatch('aax', 'a!(a*|b)', { bash: true }));
  });

  test('"aax" should match "a!(x*|b)"', () => {
    expect_truthy(isMatch('aax', 'a!(x*|b)', { bash: true }));
  });
  ...
  test('"aaz" should match "[a*(]*z"', () => {
    expect_truthy(isMatch('aaz', '[a*(]*z', { bash: true }));
  });
  ...
  test('"ab" should match "!(a!(b))"', () => {
    expect_truthy(isMatch('ab', '!(a!(b))', { bash: true }));
  });

  test('"ab" should not match "!(a)*"', () => {
    expect_truthy(!isMatch('ab', '!(a)*', { bash: true }));
  });
  ...
  test('"ab" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('ab', '*?(a)bc', { bash: true }));
  });

  test('"ab" should not match "a!(*(b|B))"', () => {
    expect_truthy(!isMatch('ab', 'a!(*(b|B))', { bash: true }));
  });
  ...
  test('"ab" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('ab', 'a(b*(foo|bar))d', { bash: true }));
  });
  ...
  test('"ab" should match "ab*(e|f)"', () => {
    expect_truthy(isMatch('ab', 'ab*(e|f)', { bash: true }));
  });
  ...
  test('"ab" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('ab', 'ab**(e|f)g', { bash: true }));
  });
  ...
  test('"ab" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('ab', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"ab/cXd/efXg/hi" should match "**/*X*/**/*i"', () => {
    expect_truthy(isMatch('ab/cXd/efXg/hi', '**/*X*/**/*i', { bash: true }));
  });
  ...
  test('"ab/cXd/efXg/hi" should match "*Xg*i"', () => {
    expect_truthy(isMatch('ab/cXd/efXg/hi', '*Xg*i', { bash: true }));
  });
  ...
  test('"abab" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('abab', '(a+|b)*', { bash: true }));
  });
  ...
  test('"abab" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('abab', '*?(a)bc', { bash: true }));
  });

  test('"abab" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('abab', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"abab" should not match "ab*(e|f)"', () => {
    expect_truthy(!isMatch('abab', 'ab*(e|f)', { bash: true }));
  });

  test('"abab" should match "ab**"', () => {
    expect_truthy(isMatch('abab', 'ab**', { bash: true }));
  });
  ...
  test('"abab" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('abab', 'ab**(e|f)g', { bash: true }));
  });

  test('"abab" should not match "ab***ef"', () => {
    expect_truthy(!isMatch('abab', 'ab***ef', { bash: true }));
  });
  ...
  test('"abab" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('abab', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"abb" should match "!(*.*)"', () => {
    expect_truthy(isMatch('abb', '!(*.*)', { bash: true }));
  });

  test('"abb" should not match "!(a)*"', () => {
    expect_truthy(!isMatch('abb', '!(a)*', { bash: true }));
  });

  test('"abb" should not match "a!(b)*"', () => {
    expect_truthy(!isMatch('abb', 'a!(b)*', { bash: true }));
  });

  test('"abbcd" should match "@(ab|a*(b))*(c)d"', () => {
    expect_truthy(isMatch('abbcd', '@(ab|a*(b))*(c)d', { bash: true }));
  });

  test('"abc" should not match "\\a\\b\\c"', () => {
    expect_truthy(!isMatch('abc', '\\a\\b\\c', { bash: true }));
  });

  test('"aBc" should match "a!(@(b|B))"', () => {
    expect_truthy(isMatch('aBc', 'a!(@(b|B))', { bash: true }));
  });

  test('"abcd" should match "?@(a|b)*@(c)d"', () => {
    expect_truthy(isMatch('abcd', '?@(a|b)*@(c)d', { bash: true }));
  });

  test('"abcd" should match "@(ab|a*@(b))*(c)d"', () => {
    expect_truthy(isMatch('abcd', '@(ab|a*@(b))*(c)d', { bash: true }));
  });

  test('"abcd/abcdefg/abcdefghijk/abcdefghijklmnop.txt" should match "**/*a*b*g*n*t"', () => {
    expect_truthy(isMatch('abcd/abcdefg/abcdefghijk/abcdefghijklmnop.txt', '**/*a*b*g*n*t', { bash: true }));
  });

  test('"abcd/abcdefg/abcdefghijk/abcdefghijklmnop.txtz" should not match "**/*a*b*g*n*t"', () => {
    expect_truthy(!isMatch('abcd/abcdefg/abcdefghijk/abcdefghijklmnop.txtz', '**/*a*b*g*n*t', { bash: true }));
  });

  test('"abcdef" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('abcdef', '(a+|b)*', { bash: true }));
  });
  ...
  test('"abcdef" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('abcdef', '*?(a)bc', { bash: true }));
  });

  test('"abcdef" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('abcdef', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"abcdef" should not match "ab*(e|f)"', () => {
    expect_truthy(!isMatch('abcdef', 'ab*(e|f)', { bash: true }));
  });
  ...
  test('"abcdef" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('abcdef', 'ab**(e|f)g', { bash: true }));
  });
  ...
  test('"abcdef" should match "ab*d+(e|f)"', () => {
    expect_truthy(isMatch('abcdef', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"abcfef" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('abcfef', '(a+|b)*', { bash: true }));
  });
  ...
  test('"abcfef" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('abcfef', '*?(a)bc', { bash: true }));
  });

  test('"abcfef" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('abcfef', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"abcfef" should not match "ab*(e|f)"', () => {
    expect_truthy(!isMatch('abcfef', 'ab*(e|f)', { bash: true }));
  });
  ...
  test('"abcfef" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('abcfef', 'ab**(e|f)g', { bash: true }));
  });
  ...
  test('"abcfef" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('abcfef', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"abcfefg" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('abcfefg', '(a+|b)*', { bash: true }));
  });
  ...
  test('"abcfefg" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('abcfefg', '*?(a)bc', { bash: true }));
  });

  test('"abcfefg" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('abcfefg', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"abcfefg" should not match "ab*(e|f)"', () => {
    expect_truthy(!isMatch('abcfefg', 'ab*(e|f)', { bash: true }));
  });

  test('"abcfefg" should match "ab**"', () => {
    expect_truthy(isMatch('abcfefg', 'ab**', { bash: true }));
  });
  ...
  test('"abcfefg" should match "ab**(e|f)g"', () => {
    expect_truthy(isMatch('abcfefg', 'ab**(e|f)g', { bash: true }));
  });

  test('"abcfefg" should not match "ab***ef"', () => {
    expect_truthy(!isMatch('abcfefg', 'ab***ef', { bash: true }));
  });
  ...
  test('"abcfefg" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('abcfefg', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"abcx" should match "!([[*])*"', () => {
    expect_truthy(isMatch('abcx', '!([[*])*', { bash: true }));
  });

  test('"abcx" should match "+(a|b\\[)*"', () => {
    expect_truthy(isMatch('abcx', '+(a|b\\[)*', { bash: true }));
  });

  test('"abcx" should not match "[a*(]*z"', () => {
    expect_truthy(!isMatch('abcx', '[a*(]*z', { bash: true }));
  });

  test('"abcXdefXghi" should match "*X*i"', () => {
    expect_truthy(isMatch('abcXdefXghi', '*X*i', { bash: true }));
  });

  test('"abcz" should match "!([[*])*"', () => {
    expect_truthy(isMatch('abcz', '!([[*])*', { bash: true }));
  });

  test('"abcz" should match "+(a|b\\[)*"', () => {
    expect_truthy(isMatch('abcz', '+(a|b\\[)*', { bash: true }));
  });

  test('"abcz" should match "[a*(]*z"', () => {
    expect_truthy(isMatch('abcz', '[a*(]*z', { bash: true }));
  });

  test('"abd" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('abd', '(a+|b)*', { bash: true }));
  });
  ...
  test('"abd" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('abd', '*?(a)bc', { bash: true }));
  });

  test('"abd" should match "a!(*(b|B))"', () => {
    expect_truthy(isMatch('abd', 'a!(*(b|B))', { bash: true }));
  });
  ...
  test('"abd" should not match "a!(@(b|B))d"', () => {
    expect_truthy(!isMatch('abd', 'a!(@(b|B))d', { bash: true }));
  });

  test('"abd" should match "a(b*(foo|bar))d"', () => {
    expect_truthy(isMatch('abd', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"abd" should match "a+(b|c)d"', () => {
    expect_truthy(isMatch('abd', 'a+(b|c)d', { bash: true }));
  });
  ...
  test('"abd" should not match "ab*(e|f)"', () => {
    expect_truthy(!isMatch('abd', 'ab*(e|f)', { bash: true }));
  });

  test('"abd" should match "ab**"', () => {
    expect_truthy(isMatch('abd', 'ab**', { bash: true }));
  });
  ...
  test('"abd" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('abd', 'ab**(e|f)g', { bash: true }));
  });

  test('"abd" should not match "ab***ef"', () => {
    expect_truthy(!isMatch('abd', 'ab***ef', { bash: true }));
  });
  ...
  test('"abd" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('abd', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"abef" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('abef', '(a+|b)*', { bash: true }));
  });
  ...
  test('"abef" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('abef', '*?(a)bc', { bash: true }));
  });

  test('"abef" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('abef', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"abef" should match "ab*(e|f)"', () => {
    expect_truthy(isMatch('abef', 'ab*(e|f)', { bash: true }));
  });
  ...
  test('"abef" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('abef', 'ab**(e|f)g', { bash: true }));
  });
  ...
  test('"abef" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('abef', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"abz" should not match "a!(*)"', () => {
    expect_truthy(!isMatch('abz', 'a!(*)', { bash: true }));
  });

  test('"abz" should match "a!(z)"', () => {
    expect_truthy(isMatch('abz', 'a!(z)', { bash: true }));
  });
  ...
  test('"ac" should not match "!(a)*"', () => {
    expect_truthy(!isMatch('ac', '!(a)*', { bash: true }));
  });

  test('"ac" should match "*(@(a))a@(c)"', () => {
    expect_truthy(isMatch('ac', '*(@(a))a@(c)', { bash: true }));
  });

  test('"ac" should match "a!(*(b|B))"', () => {
    expect_truthy(isMatch('ac', 'a!(*(b|B))', { bash: true }));
  });
  ...
  test('"ac" should match "a!(b)*"', () => {
    expect_truthy(isMatch('ac', 'a!(b)*', { bash: true }));
  });

  test('"accdef" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('accdef', '(a+|b)*', { bash: true }));
  });
  ...
  test('"accdef" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('accdef', '*?(a)bc', { bash: true }));
  });

  test('"accdef" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('accdef', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"accdef" should not match "ab*(e|f)"', () => {
    expect_truthy(!isMatch('accdef', 'ab*(e|f)', { bash: true }));
  });

  test('"accdef" should not match "ab**"', () => {
    expect_truthy(!isMatch('accdef', 'ab**', { bash: true }));
  });
  ...
  test('"accdef" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('accdef', 'ab**(e|f)g', { bash: true }));
  });

  test('"accdef" should not match "ab***ef"', () => {
    expect_truthy(!isMatch('accdef', 'ab***ef', { bash: true }));
  });
  ...
  test('"accdef" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('accdef', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"acd" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('acd', '(a+|b)*', { bash: true }));
  });
  ...
  test('"acd" should not match "*?(a)bc"', () => {
    expect_truthy(!isMatch('acd', '*?(a)bc', { bash: true }));
  });

  test('"acd" should match "@(ab|a*(b))*(c)d"', () => {
    expect_truthy(isMatch('acd', '@(ab|a*(b))*(c)d', { bash: true }));
  });

  test('"acd" should match "a!(*(b|B))"', () => {
    expect_truthy(isMatch('acd', 'a!(*(b|B))', { bash: true }));
  });
  ...
  test('"acd" should match "a!(@(b|B))d"', () => {
    expect_truthy(isMatch('acd', 'a!(@(b|B))d', { bash: true }));
  });

  test('"acd" should not match "a(b*(foo|bar))d"', () => {
    expect_truthy(!isMatch('acd', 'a(b*(foo|bar))d', { bash: true }));
  });

  test('"acd" should match "a+(b|c)d"', () => {
    expect_truthy(isMatch('acd', 'a+(b|c)d', { bash: true }));
  });
  ...
  test('"acd" should not match "ab*(e|f)"', () => {
    expect_truthy(!isMatch('acd', 'ab*(e|f)', { bash: true }));
  });

  test('"acd" should not match "ab**"', () => {
    expect_truthy(!isMatch('acd', 'ab**', { bash: true }));
  });
  ...
  test('"acd" should not match "ab**(e|f)g"', () => {
    expect_truthy(!isMatch('acd', 'ab**(e|f)g', { bash: true }));
  });

  test('"acd" should not match "ab***ef"', () => {
    expect_truthy(!isMatch('acd', 'ab***ef', { bash: true }));
  });
  ...
  test('"acd" should not match "ab*d+(e|f)"', () => {
    expect_truthy(!isMatch('acd', 'ab*d+(e|f)', { bash: true }));
  });
  ...
  test('"ax" should match "?(a*|b)"', () => {
    expect_truthy(isMatch('ax', '?(a*|b)', { bash: true }));
  });
  ...
  test('"axz" should not match "a+(z)"', () => {
    expect_truthy(!isMatch('axz', 'a+(z)', { bash: true }));
  });

  test('"az" should not match "a!(*)"', () => {
    expect_truthy(!isMatch('az', 'a!(*)', { bash: true }));
  });

  test('"az" should not match "a!(z)"', () => {
    expect_truthy(!isMatch('az', 'a!(z)', { bash: true }));
  });
  ...
  test('"b" should match "!(a)*"', () => {
    expect_truthy(isMatch('b', '!(a)*', { bash: true }));
  });

  test('"b" should match "(a+|b)*"', () => {
    expect_truthy(isMatch('b', '(a+|b)*', { bash: true }));
  });
  ...
  test('"b.a" should match "(b|a).(a)"', () => {
    expect_truthy(isMatch('b.a', '(b|a).(a)', { bash: true }));
  });
  ...
  test('"b/a" should not match "!(b/a)"', () => {
    expect_truthy(!isMatch('b/a', '!(b/a)', { bash: true }));
  });

  test('"b/b" should match "!(b/a)"', () => {
    expect_truthy(isMatch('b/b', '!(b/a)', { bash: true }));
  });

  test('"b/c" should match "!(b/a)"', () => {
    expect_truthy(isMatch('b/c', '!(b/a)', { bash: true }));
  });

  test('"b/c" should not match "b/!(c)"', () => {
    expect_truthy(!isMatch('b/c', 'b/!(c)', { bash: true }));
  });

  test('"b/c" should match "b/!(cc)"', () => {
    expect_truthy(isMatch('b/c', 'b/!(cc)', { bash: true }));
  });

  test('"b/c.txt" should not match "b/!(c).txt"', () => {
    expect_truthy(!isMatch('b/c.txt', 'b/!(c).txt', { bash: true }));
  });

  test('"b/c.txt" should match "b/!(cc).txt"', () => {
    expect_truthy(isMatch('b/c.txt', 'b/!(cc).txt', { bash: true }));
  });

  test('"b/cc" should match "b/!(c)"', () => {
    expect_truthy(isMatch('b/cc', 'b/!(c)', { bash: true }));
  });

  test('"b/cc" should not match "b/!(cc)"', () => {
    expect_truthy(!isMatch('b/cc', 'b/!(cc)', { bash: true }));
  });

  test('"b/cc.txt" should not match "b/!(c).txt"', () => {
    expect_truthy(!isMatch('b/cc.txt', 'b/!(c).txt', { bash: true }));
  });

  test('"b/cc.txt" should not match "b/!(cc).txt"', () => {
    expect_truthy(!isMatch('b/cc.txt', 'b/!(cc).txt', { bash: true }));
  });

  test('"b/ccc" should match "b/!(c)"', () => {
    expect_truthy(isMatch('b/ccc', 'b/!(c)', { bash: true }));
  });

  test('"ba" should match "!(a!(b))"', () => {
    expect_truthy(isMatch('ba', '!(a!(b))', { bash: true }));
  });

  test('"ba" should match "b?(a|b)"', () => {
    expect_truthy(isMatch('ba', 'b?(a|b)', { bash: true }));
  });

  test('"baaac" should not match "*(@(a))a@(c)"', () => {
    expect_truthy(!isMatch('baaac', '*(@(a))a@(c)', { bash: true }));
  });

  test('"bar" should match "!(foo)"', () => {
    expect_truthy(isMatch('bar', '!(foo)', { bash: true }));
  });
  ...
  test('"bar" should match "!(foo)b*"', () => {
    expect_truthy(isMatch('bar', '!(foo)b*', { bash: true }));
  });
  ...
  test('"baz" should match "!(foo)*"', () => {
    expect_truthy(isMatch('baz', '!(foo)*', { bash: true }));
  });

  test('"baz" should match "!(foo)b*"', () => {
    expect_truthy(isMatch('baz', '!(foo)b*', { bash: true }));
  });
  ...
  test('"bb" should match "!(a!(b))"', () => {
    expect_truthy(isMatch('bb', '!(a!(b))', { bash: true }));
  });

  test('"bb" should match "!(a)*"', () => {
    expect_truthy(isMatch('bb', '!(a)*', { bash: true }));
  });
  ...
  test('"bb" should not match "a?(a|b)"', () => {
    expect_truthy(!isMatch('bb', 'a?(a|b)', { bash: true }));
  });

  test('"bbc" should match "!([[*])*"', () => {
    expect_truthy(isMatch('bbc', '!([[*])*', { bash: true }));
  });

  test('"bbc" should not match "+(a|b\\[)*"', () => {
    expect_truthy(!isMatch('bbc', '+(a|b\\[)*', { bash: true }));
  });

  test('"bbc" should not match "[a*(]*z"', () => {
    expect_truthy(!isMatch('bbc', '[a*(]*z', { bash: true }));
  });

  test('"bz" should not match "a+(z)"', () => {
    expect_truthy(!isMatch('bz', 'a+(z)', { bash: true }));
  });

  test('"c" should not match "*(@(a))a@(c)"', () => {
    expect_truthy(!isMatch('c', '*(@(a))a@(c)', { bash: true }));
  });
  ...
  test('"c.a" should not match "(b|a).(a)"', () => {
    expect_truthy(!isMatch('c.a', '(b|a).(a)', { bash: true }));
  });

  test('"c.a" should not match "*.!(a)"', () => {
    expect_truthy(!isMatch('c.a', '*.!(a)', { bash: true }));
  });

  test('"c.a" should not match "*.+(b|d)"', () => {
    expect_truthy(!isMatch('c.a', '*.+(b|d)', { bash: true }));
  });
  ...
  test('"c.c" should not match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(!isMatch('c.c', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"c.c" should not match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(!isMatch('c.c', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });
  ...
  test('"c.js" should not match "!(*.js)"', () => {
    expect_truthy(!isMatch('c.js', '!(*.js)', { bash: true }));
  });
  ...
  test('"c/a/v" should match "c/!(z)/v"', () => {
    expect_truthy(isMatch('c/a/v', 'c/!(z)/v', { bash: true }));
  });
  ...
  test('"c/z/v" should not match "*(z)"', () => {
    expect_truthy(!isMatch('c/z/v', '*(z)', { bash: true }));
  });
  ...
  test('"c/z/v" should not match "c/!(z)/v"', () => {
    expect_truthy(!isMatch('c/z/v', 'c/!(z)/v', { bash: true }));
  });
  ...
  test('"cc.a" should not match "(b|a).(a)"', () => {
    expect_truthy(!isMatch('cc.a', '(b|a).(a)', { bash: true }));
  });
  ...
  test('"ccc" should match "!(a)*"', () => {
    expect_truthy(isMatch('ccc', '!(a)*', { bash: true }));
  });

  test('"ccc" should not match "a!(b)*"', () => {
    expect_truthy(!isMatch('ccc', 'a!(b)*', { bash: true }));
  });

  test('"cow" should match "!(*.*)"', () => {
    expect_truthy(isMatch('cow', '!(*.*)', { bash: true }));
  });
  ...
  test('"cz" should not match "a!(*)"', () => {
    expect_truthy(!isMatch('cz', 'a!(*)', { bash: true }));
  });

  test('"cz" should not match "a!(z)"', () => {
    expect_truthy(!isMatch('cz', 'a!(z)', { bash: true }));
  });
  ...
  test('"d.a.d" should match "*.!(a)"', () => {
    expect_truthy(isMatch('d.a.d', '*.!(a)', { bash: true }));
  });

  test('"d.a.d" should match "*.+(b|d)"', () => {
    expect_truthy(isMatch('d.a.d', '*.+(b|d)', { bash: true }));
  });

  test('"d.d" should match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(isMatch('d.d', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"d.d" should not match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(!isMatch('d.d', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });

  test('"d.js.d" should match "!(*.js)"', () => {
    expect_truthy(isMatch('d.js.d', '!(*.js)', { bash: true }));
  });
  ...
  test('"dd.aa.d" should not match "(b|a).(a)"', () => {
    expect_truthy(!isMatch('dd.aa.d', '(b|a).(a)', { bash: true }));
  });
  ...
  test('"def" should not match "()ef"', () => {
    expect_truthy(!isMatch('def', '()ef', { bash: true }));
  });

  test('"e.e" should match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(isMatch('e.e', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"e.e" should not match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(!isMatch('e.e', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });

  test('"ef" should match "()ef"', () => {
    expect_truthy(isMatch('ef', '()ef', { bash: true }));
  });

  test('"effgz" should match "@(b+(c)d|e*(f)g?|?(h)i@(j|k))"', () => {
    expect_truthy(isMatch('effgz', '@(b+(c)d|e*(f)g?|?(h)i@(j|k))', { bash: true }));
  });

  test('"efgz" should match "@(b+(c)d|e*(f)g?|?(h)i@(j|k))"', () => {
    expect_truthy(isMatch('efgz', '@(b+(c)d|e*(f)g?|?(h)i@(j|k))', { bash: true }));
  });

  test('"egz" should match "@(b+(c)d|e*(f)g?|?(h)i@(j|k))"', () => {
    expect_truthy(isMatch('egz', '@(b+(c)d|e*(f)g?|?(h)i@(j|k))', { bash: true }));
  });
  ...
  test('"egzefffgzbcdij" should match "*(b+(c)d|e*(f)g?|?(h)i@(j|k))"', () => {
    expect_truthy(isMatch('egzefffgzbcdij', '*(b+(c)d|e*(f)g?|?(h)i@(j|k))', { bash: true }));
  });

  test('"f" should not match "!(f!(o))"', () => {
    expect_truthy(!isMatch('f', '!(f!(o))', { bash: true }));
  });
  ...
  test('"f" should not match "!(f)"', () => {
    expect_truthy(!isMatch('f', '!(f)', { bash: true }));
  });
  ...
  test('"f.a" should not match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(!isMatch('f.a', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"f.f" should match "!(*.a|*.b|*.c)"', () => {
    expect_truthy(isMatch('f.f', '!(*.a|*.b|*.c)', { bash: true }));
  });
  ...
  test('"f.f" should not match "*.(a|b|@(ab|a*@(b))*(c)d)"', () => {
    expect_truthy(!isMatch('f.f', '*.(a|b|@(ab|a*@(b))*(c)d)', { bash: true }));
  });

  test('"fa" should not match "!(f!(o))"', () => {
    expect_truthy(!isMatch('fa', '!(f!(o))', { bash: true }));
  });
  ...
  test('"fb" should not match "!(f!(o))"', () => {
    expect_truthy(!isMatch('fb', '!(f!(o))', { bash: true }));
  });
  ...
  test('"fff" should match "!(f)"', () => {
    expect_truthy(isMatch('fff', '!(f)', { bash: true }));
  });
  ...
  test('"fffooofoooooffoofffooofff" should match "*(*(f)*(o))"', () => {
    expect_truthy(isMatch('fffooofoooooffoofffooofff', '*(*(f)*(o))', { bash: true }));
  });

  test('"ffo" should match "*(f*(o))"', () => {
    expect_truthy(isMatch('ffo', '*(f*(o))', { bash: true }));
  });

  test('"file.C" should not match "*.c?(c)"', () => {
    expect_truthy(!isMatch('file.C', '*.c?(c)', { bash: true }));
  });
  ...
  test('"file.cc" should match "*.c?(c)"', () => {
    expect_truthy(isMatch('file.cc', '*.c?(c)', { bash: true }));
  });

  test('"file.ccc" should not match "*.c?(c)"', () => {
    expect_truthy(!isMatch('file.ccc', '*.c?(c)', { bash: true }));
  });

  test('"fo" should match "!(f!(o))"', () => {
    expect_truthy(isMatch('fo', '!(f!(o))', { bash: true }));
  });
  ...
  test('"fofo" should match "*(f*(o))"', () => {
    expect_truthy(isMatch('fofo', '*(f*(o))', { bash: true }));
  });

  test('"fofoofoofofoo" should match "*(fo|foo)"', () => {
    expect_truthy(isMatch('fofoofoofofoo', '*(fo|foo)', { bash: true }));
  });
  ...
  test('"foo" should match "!(f)"', () => {
    expect_truthy(isMatch('foo', '!(f)', { bash: true }));
  });
  ...
  test('"foo" should not match "!(foo)b*"', () => {
    expect_truthy(!isMatch('foo', '!(foo)b*', { bash: true }));
  });

  test('"foo" should match "!(x)"', () => {
    expect_truthy(isMatch('foo', '!(x)', { bash: true }));
  });
  ...
  test('"foo" should match "*"', () => {
    expect_truthy(isMatch('foo', '*', { bash: true }));
  });
  ...
  test('"foo" should not match "*(@(a))a@(c)"', () => {
    expect_truthy(!isMatch('foo', '*(@(a))a@(c)', { bash: true }));
  });
  ...
  test('"foo" should not match "*(a|b\\[)"', () => {
    expect_truthy(!isMatch('foo', '*(a|b\\[)', { bash: true }));
  });

  test('"foo" should match "*(a|b\\[)|f*"', () => {
    expect_truthy(isMatch('foo', '*(a|b\\[)|f*', { bash: true }));
  });
  ...
  test('"foo" should not match "bar"', () => {
    expect_truthy(!isMatch('foo', 'bar', { bash: true }));
  });
  ...
  test('"foo" should not match "fo"', () => {
    expect_truthy(!isMatch('foo', 'fo', { bash: true }));
  });
  ...
  test('"foo.js" should not match "!(foo).js"', () => {
    expect_truthy(!isMatch('foo.js', '!(foo).js', { bash: true }));
  });

  test('"foo.js.js" should match "*.!(js)"', () => {
    expect_truthy(isMatch('foo.js.js', '*.!(js)', { bash: true }));
  });
  ...
  test('"foo.js.js" should not match "*.!(js)*.!(js)"', () => {
    expect_truthy(!isMatch('foo.js.js', '*.!(js)*.!(js)', { bash: true }));
  });
  ...
  test('"foo.txt" should match "**/!(bar).txt"', () => {
    expect_truthy(isMatch('foo.txt', '**/!(bar).txt', { bash: true }));
  });
  ...
  test('"foo/bar" should match "foo/!(foo)"', () => {
    expect_truthy(isMatch('foo/bar', 'foo/!(foo)', { bash: true }));
  });
  ...
  test('"foo/bar/baz.jsx" should match "foo/bar/**/*.+(js|jsx)"', () => {
    expect_truthy(isMatch('foo/bar/baz.jsx', 'foo/bar/**/*.+(js|jsx)', { bash: true }));
  });
  ...
  test('"foo/bb/aa/rr" should match "**/**/**"', () => {
    expect_truthy(isMatch('foo/bb/aa/rr', '**/**/**', { bash: true }));
  });
  ...
  test('"foo/bba/arr" should match "*/*/*"', () => {
    expect_truthy(isMatch('foo/bba/arr', '*/*/*', { bash: true }));
  });

  test('"foo/bba/arr" should match "foo*"', () => {
    expect_truthy(isMatch('foo/bba/arr', 'foo*', { bash: true }));
  });
  ...
  test('"foo/bba/arr" should match "foo/**arr"', () => {
    expect_truthy(isMatch('foo/bba/arr', 'foo/**arr', { bash: true }));
  });

  test('"foo/bba/arr" should not match "foo/**z"', () => {
    expect_truthy(!isMatch('foo/bba/arr', 'foo/**z', { bash: true }));
  });
  ...
  test('"foob" should not match "!(foo)b*"', () => {
    expect_truthy(!isMatch('foob', '!(foo)b*', { bash: true }));
  });

  test('"foob" should not match "(foo)bb"', () => {
    expect_truthy(!isMatch('foob', '(foo)bb', { bash: true }));
  });

  test('"foobar" should match "!(foo)"', () => {
    expect_truthy(isMatch('foobar', '!(foo)', { bash: true }));
  });
  ...
  test('"foobar" should not match "!(foo)b*"', () => {
    expect_truthy(!isMatch('foobar', '!(foo)b*', { bash: true }));
  });
  ...
  test('"foobar" should match "*ob*a*r*"', () => {
    expect_truthy(isMatch('foobar', '*ob*a*r*', { bash: true }));
  });

  test('"foobar" should match "foo\\*bar"', () => {
    expect_truthy(isMatch('foobar', 'foo*bar', { bash: true }));
  });

  test('"foobb" should not match "!(foo)b*"', () => {
    expect_truthy(!isMatch('foobb', '!(foo)b*', { bash: true }));
  });

  test('"foobb" should match "(foo)bb"', () => {
    expect_truthy(isMatch('foobb', '(foo)bb', { bash: true }));
  });

  test('"(foo)bb" should match "\\(foo\\)bb"', () => {
    expect_truthy(isMatch('(foo)bb', '\\(foo\\)bb', { bash: true }));
  });

  test('"foofoofo" should match "@(foo|f|fo)*(f|of+(o))"', () => {
    expect_truthy(isMatch('foofoofo', '@(foo|f|fo)*(f|of+(o))', { bash: true }));
  });
  ...
  test('"fooofoofofooo" should match "*(f*(o))"', () => {
    expect_truthy(isMatch('fooofoofofooo', '*(f*(o))', { bash: true }));
  });

  test('"foooofo" should match "*(f*(o))"', () => {
    expect_truthy(isMatch('foooofo', '*(f*(o))', { bash: true }));
  });

  test('"foooofof" should match "*(f*(o))"', () => {
    expect_truthy(isMatch('foooofof', '*(f*(o))', { bash: true }));
  });
  ...
  test('"foooofofx" should not match "*(f*(o))"', () => {
    expect_truthy(!isMatch('foooofofx', '*(f*(o))', { bash: true }));
  });

  test('"foooxfooxfoxfooox" should match "*(f*(o)x)"', () => {
    expect_truthy(isMatch('foooxfooxfoxfooox', '*(f*(o)x)', { bash: true }));
  });

  test('"foooxfooxfxfooox" should match "*(f*(o)x)"', () => {
    expect_truthy(isMatch('foooxfooxfxfooox', '*(f*(o)x)', { bash: true }));
  });

  test('"foooxfooxofoxfooox" should not match "*(f*(o)x)"', () => {
    expect_truthy(!isMatch('foooxfooxofoxfooox', '*(f*(o)x)', { bash: true }));
  });

  test('"foot" should match "@(!(z*)|*x)"', () => {
    expect_truthy(isMatch('foot', '@(!(z*)|*x)', { bash: true }));
  });

  test('"foox" should match "@(!(z*)|*x)"', () => {
    expect_truthy(isMatch('foox', '@(!(z*)|*x)', { bash: true }));
  });

  test('"fz" should not match "*(z)"', () => {
    expect_truthy(!isMatch('fz', '*(z)', { bash: true }));
  });
  ...
  test('"moo.cow" should not match "!(moo).!(cow)"', () => {
    expect_truthy(!isMatch('moo.cow', '!(moo).!(cow)', { bash: true }));
  });

  test('"moo.cow" should not match "!(*).!(*)"', () => {
    expect_truthy(!isMatch('moo.cow', '!(*).!(*)', { bash: true }));
  });
  ...
  test('"mad.moo.cow" should not match "!(*.*).!(*.*)"', () => {
    expect_truthy(!isMatch('mad.moo.cow', '!(*.*).!(*.*)', { bash: true }));
  });
  ...
  test('"Makefile" should match "!(*.c|*.h|Makefile.in|config*|README)"', () => {
    expect_truthy(isMatch('Makefile', '!(*.c|*.h|Makefile.in|config*|README)', { bash: true }));
  });

  test('"Makefile.in" should not match "!(*.c|*.h|Makefile.in|config*|README)"', () => {
    expect_truthy(!isMatch('Makefile.in', '!(*.c|*.h|Makefile.in|config*|README)', { bash: true }));
  });

  test('"moo" should match "!(*.*)"', () => {
    expect_truthy(isMatch('moo', '!(*.*)', { bash: true }));
  });
  ...
  test('"mucca.pazza" should not match "mu!(*(c))?.pa!(*(z))?"', () => {
    expect_truthy(!isMatch('mucca.pazza', 'mu!(*(c))?.pa!(*(z))?', { bash: true }));
  });

  test('"ofoofo" should match "*(of+(o))"', () => {
    expect_truthy(isMatch('ofoofo', '*(of+(o))', { bash: true }));
  });

  test('"ofoofo" should match "*(of+(o)|f)"', () => {
    expect_truthy(isMatch('ofoofo', '*(of+(o)|f)', { bash: true }));
  });

  test('"ofooofoofofooo" should not match "*(f*(o))"', () => {
    expect_truthy(!isMatch('ofooofoofofooo', '*(f*(o))', { bash: true }));
  });

  test('"ofoooxoofxo" should match "*(*(of*(o)x)o)"', () => {
    expect_truthy(isMatch('ofoooxoofxo', '*(*(of*(o)x)o)', { bash: true }));
  });

  test('"ofoooxoofxoofoooxoofxo" should match "*(*(of*(o)x)o)"', () => {
    expect_truthy(isMatch('ofoooxoofxoofoooxoofxo', '*(*(of*(o)x)o)', { bash: true }));
  });

  test('"ofoooxoofxoofoooxoofxofo" should not match "*(*(of*(o)x)o)"', () => {
    expect_truthy(!isMatch('ofoooxoofxoofoooxoofxofo', '*(*(of*(o)x)o)', { bash: true }));
  });

  test('"ofoooxoofxoofoooxoofxoo" should match "*(*(of*(o)x)o)"', () => {
    expect_truthy(isMatch('ofoooxoofxoofoooxoofxoo', '*(*(of*(o)x)o)', { bash: true }));
  });

  test('"ofoooxoofxoofoooxoofxooofxofxo" should match "*(*(of*(o)x)o)"', () => {
    expect_truthy(isMatch('ofoooxoofxoofoooxoofxooofxofxo', '*(*(of*(o)x)o)', { bash: true }));
  });

  test('"ofxoofxo" should match "*(*(of*(o)x)o)"', () => {
    expect_truthy(isMatch('ofxoofxo', '*(*(of*(o)x)o)', { bash: true }));
  });

  test('"oofooofo" should match "*(of|oof+(o))"', () => {
    expect_truthy(isMatch('oofooofo', '*(of|oof+(o))', { bash: true }));
  });

  test('"ooo" should match "!(f)"', () => {
    expect_truthy(isMatch('ooo', '!(f)', { bash: true }));
  });
  ...
  test('"oxfoxfox" should not match "*(oxf+(ox))"', () => {
    expect_truthy(!isMatch('oxfoxfox', '*(oxf+(ox))', { bash: true }));
  });

  test('"oxfoxoxfox" should match "*(oxf+(ox))"', () => {
    expect_truthy(isMatch('oxfoxoxfox', '*(oxf+(ox))', { bash: true }));
  });

  test('"para" should match "para*([0-9])"', () => {
    expect_truthy(isMatch('para', 'para*([0-9])', { bash: true }));
  });
  ...
  test('"para.38" should match "para!(*.[00-09])"', () => {
    expect_truthy(isMatch('para.38', 'para!(*.[00-09])', { bash: true }));
  });

  test('"para.graph" should match "para!(*.[0-9])"', () => {
    expect_truthy(isMatch('para.graph', 'para!(*.[0-9])', { bash: true }));
  });

  test('"para13829383746592" should match "para*([0-9])"', () => {
    expect_truthy(isMatch('para13829383746592', 'para*([0-9])', { bash: true }));
  });

  test('"para381" should not match "para?([345]|99)1"', () => {
    expect_truthy(!isMatch('para381', 'para?([345]|99)1', { bash: true }));
  });

  test('"para39" should match "para!(*.[0-9])"', () => {
    expect_truthy(isMatch('para39', 'para!(*.[0-9])', { bash: true }));
  });

  test('"para987346523" should match "para+([0-9])"', () => {
    expect_truthy(isMatch('para987346523', 'para+([0-9])', { bash: true }));
  });

  test('"para991" should match "para?([345]|99)1"', () => {
    expect_truthy(isMatch('para991', 'para?([345]|99)1', { bash: true }));
  });

  test('"paragraph" should match "para!(*.[0-9])"', () => {
    expect_truthy(isMatch('paragraph', 'para!(*.[0-9])', { bash: true }));
  });
  ...
  test('"paragraph" should match "para@(chute|graph)"', () => {
    expect_truthy(isMatch('paragraph', 'para@(chute|graph)', { bash: true }));
  });

  test('"paramour" should not match "para@(chute|graph)"', () => {
    expect_truthy(!isMatch('paramour', 'para@(chute|graph)', { bash: true }));
  });

  test('"parse.y" should match "!(*.c|*.h|Makefile.in|config*|README)"', () => {
    expect_truthy(isMatch('parse.y', '!(*.c|*.h|Makefile.in|config*|README)', { bash: true }));
  });

  test('"shell.c" should not match "!(*.c|*.h|Makefile.in|config*|README)"', () => {
    expect_truthy(!isMatch('shell.c', '!(*.c|*.h|Makefile.in|config*|README)', { bash: true }));
  });

  test('"VMS.FILE;" should not match "*\\;[1-9]*([0-9])"', () => {
    expect_truthy(!isMatch('VMS.FILE;', '*\\;[1-9]*([0-9])', { bash: true }));
  });

  test('"VMS.FILE;0" should not match "*\\;[1-9]*([0-9])"', () => {
    expect_truthy(!isMatch('VMS.FILE;0', '*\\;[1-9]*([0-9])', { bash: true }));
  });

  test('"VMS.FILE;9" should match "*\\;[1-9]*([0-9])"', () => {
    expect_truthy(isMatch('VMS.FILE;9', '*\\;[1-9]*([0-9])', { bash: true }));
  });

  test('"VMS.FILE;1" should match "*\\;[1-9]*([0-9])"', () => {
    expect_truthy(isMatch('VMS.FILE;1', '*\\;[1-9]*([0-9])', { bash: true }));
  });
  ...
  test('"VMS.FILE;139" should match "*\\;[1-9]*([0-9])"', () => {
    expect_truthy(isMatch('VMS.FILE;139', '*\\;[1-9]*([0-9])', { bash: true }));
  });

  test('"VMS.FILE;1N" should not match "*\\;[1-9]*([0-9])"', () => {
    expect_truthy(!isMatch('VMS.FILE;1N', '*\\;[1-9]*([0-9])', { bash: true }));
  });

  test('"xfoooofof" should not match "*(f*(o))"', () => {
    expect_truthy(!isMatch('xfoooofof', '*(f*(o))', { bash: true }));
  });
  ...
  test('"XXX/adobe/courier/bold/o/normal//12/120/75/75/X/70/iso8859/1" should not match "XXX/*/*/*/*/*/*/12/*/*/*/m/*/*/*"', () => {
    expect_truthy(!isMatch('XXX/adobe/courier/bold/o/normal//12/120/75/75/X/70/iso8859/1', 'XXX/*/*/*/*/*/*/12/*/*/*/m/*/*/*', { bash: true }));
  });

  test('"z" should match "*(z)"', () => {
    expect_truthy(isMatch('z', '*(z)', { bash: true }));
  });
  ...
  test('"zf" should not match "*(z)"', () => {
    expect_truthy(!isMatch('zf', '*(z)', { bash: true }));
  });
  ...
  test('"zoot" should not match "@(!(z*)|*x)"', () => {
    expect_truthy(!isMatch('zoot', '@(!(z*)|*x)', { bash: true }));
  });

  test('"zoox" should match "@(!(z*)|*x)"', () => {
    expect_truthy(isMatch('zoox', '@(!(z*)|*x)', { bash: true }));
  });

  test('"zz" should not match "(a+|b)*"', () => {
    expect_truthy(!isMatch('zz', '(a+|b)*', { bash: true }));
  });
});
